...
public class DeleteRegistrationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (status) {
			req.getSession().setAttribute("deleteregepassmsg", "Registration Deleted Successfully");
		} else {
			req.getSession().setAttribute("deleteregfailmsg", "Failed To Delete Registration");
		}
